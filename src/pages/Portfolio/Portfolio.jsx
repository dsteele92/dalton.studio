...
const weeklyGoalsGif = require('../../assets/gifs/GoalsAppGif.gif');
const findFirmGif = require('../../assets/gifs/FindFirmGif.gif');
const bookingGif = require('../../assets/gifs/bookingGif.gif');
const triviaImg = require('../../assets/images/trivia_game.png');
const triviaGif = require('../../assets/gifs/trivia_game.gif');
